...
## 一、为什么我建议先买 MiniMax 49 元/月 Token Plan
...
![MiniMax Token Plan 活动页](/photo/minimax-volcengine-openclaw-01.jpg)
...
![MiniMax Token Plan 套餐选择](/photo/minimax-volcengine-openclaw-02.jpg)
...
### 第 3 步：打开火山引擎 ECS 购买页

入口如下：

<https://console.volcengine.com/ecs/region:ecs+cn-shanghai/buy?type=app>

![火山引擎 ECS 购买页](/photo/minimax-volcengine-openclaw-03.jpg)
...
### 第 4 步：选择实例规格、系统和基础配置

![火山引擎 ECS 配置选择](/photo/minimax-volcengine-openclaw-04.jpg)
...
![火山引擎 ECS 确认订单](/photo/minimax-volcengine-openclaw-05.jpg)
